...
angular.module('adminModule',['spBlogger.admin.controllers','spBlogger.admin.services',
	'spBlogger.admin.filters','spBlogger.admin.directives']).config(['$stateProvider', function($stateProvider){
